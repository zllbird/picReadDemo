...
//        val viewAdapter = MyAdapter(Array(30) { "Person ${it + 1}" })
        val arraylist=  arrayListOf<String>()
        for (i in 1..30 ){
            arraylist.add("$i + Person")
        }
        val viewAdapter = MyAdapter(arraylist)
...
class MyAdapter(private val myDataset: ArrayList<String>) :
    ...
    fun replace(myDataset: ArrayList<String>){
...
//            holder.item.findViewById<TextView>(R.id.user_name_text).text = "dsfakkasdfnksndjkf"
